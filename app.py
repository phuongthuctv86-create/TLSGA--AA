...
<div class="main-header">
    ...
    <p>Tác giả: Hoàng Thị Phương Thức - Trường PTDTBT Tiểu học Đường Thượng - ĐT: 0978533186</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hoàng Thị Phương Thức - Trường PTDTBT Tiểu học Đường Thượng - ĐT: 0978533186</div>", unsafe_allow_html=True)
